...
from testcases.HLJ_CRM60.operation import public_operation,aut_3839_GRKHZLCJ
...
class baidu_select_test(unittest.TestCase):
    ...
    def test_01(self):
        ...
        #调用测试用例
        self.PageOperation.excutecase(aut_3839_GRKHZLCJ.selectTest,
    ...
    def tearDownClass(self):
        #self.driver.quit()
        self.Log.info("=====Finish aut_3839_GRKHZLCJ_test=====")
