...
from testcases.HLJ_CRM60.operation import public_operation,aut_4660_YXZX
...
class baidu_select_test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.PageOperation.InsertData(self.driver, '18746007666', 'input', 'id', 'J_opSchServIpt')
        self.PageOperation.ClickButton(self.driver, 'button', 'id', 'J_opSchServBtn')
        time.sleep(3)
    ...
    def test_01(self):
        ...
        print("准备调用执行函数了")
        #调用测试用例
        self.PageOperation.excutecase(aut_4660_YXZX.marketExe,
    ...
    def tearDownClass(self):
        #self.driver.quit()
        self.Log.info("=====Finish aut_4660_YXZX_test=====")
